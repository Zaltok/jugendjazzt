...
@section('title',"Anmeldung bearbeiten" )

@section('content')
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            {{ Form::open(['route'=>['admin.anmeldung.bearbeitenSend'],'method' => 'put','class'=>'form-horizontal form-label-left']) }}
            <div class="form-group">
                <h3><label class="control-label col-md-3 col-sm-3 col-xs-12">Teilnehmer</label></h3>
                <input id="id" type="hidden" name="id" value="{{$anmeldung->id}}" />
            </div>
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input id="name" type="text"
                           ...
                           name="Vorname" required value="{{$anmeldung->Teilnehmer->Vorname}}" readonly>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input id="name" type="text"
                           ...
                           name="Nachname" required value="{{$anmeldung->Teilnehmer->Nachname }}" readonly>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input id="Geburtsdatum" type="date"
                           ...
                           name="Geburtsdatum"
                           @if($anmeldung->Teilnehmer->Geburtstag)
                                value="{{$anmeldung->Teilnehmer->Geburtstag}}" readonly
                           @endif
                                   ">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input id="PLZ" type="text"
                           ...
                           name="PLZ"
                           @if($anmeldung->Teilnehmer->PLZ)
                           value="{{$anmeldung->Teilnehmer->PLZ}}"
                           @endif
                    >
                    @if($errors->has('PLZ'))
                        <ul class="parsley-errors-list filled">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input id="Ort" type="text"
                           ...
                           name="Ort"
                           @if($anmeldung->Teilnehmer->Ort)
                           value="{{$anmeldung->Teilnehmer->Ort}}"
                           @endif
                    >
                    @if($errors->has('Ort'))
                        <ul class="parsley-errors-list filled">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input id="Strasse" type="text"
                           ...
                           name="Strasse"
                           @if($anmeldung->Teilnehmer->Strasse)
                           value="{{$anmeldung->Teilnehmer->Strasse}}"
                           @endif
                    >
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input id="Telefon" type="text"
                           ...
                           name="Telefon"
                           @if($anmeldung->Teilnehmer->Telefon)
                           value="{{$anmeldung->Teilnehmer->Telefon}}"
                           @endif
                    >
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input id="Mobil" type="text"
                           ...
                           name="Mobil"
                           @if($anmeldung->Teilnehmer->Mobil)
                           value="{{$anmeldung->Teilnehmer->Mobil}}"
                           @endif
                    >
                    @if($errors->has('Mobil'))
                        <ul class="parsley-errors-list filled">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input id="AG" type="text"
                           ...
                           name="AG"
                           value="{{$anmeldung->Teilnehmer->AGBB}}"
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input id="BigBand" type="number"
                           ...
                           name="BigBand"
                           value="{{$anmeldung->Teilnehmer->bigband}}"
                    >
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input id="Combo" type="number"
                           ...
                           name="Combo"
                           value="{{$anmeldung->Teilnehmer->combo}}"
                    >
                    @if($errors->has('Combo'))
                        <ul class="parsley-errors-list filled">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    {!! Form::select('Instrument', $instrumente, $hauptinstrument->id , array('class' => 'form-control col-md-7 col-xs-12 select2_group ')) !!}
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input id="instrument_seit" type="number" min="2000" max="2017"
                           ...
                           @if($hauptinstrument->Einschaetzung)
                           value="{{$hauptinstrument->Einschaetzung->seit}}"
                            @endif
                    >
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input id="instrument_unt" type="number" min="2000" max="2017"
                           ...
                           name="instrument_unt"
                           @if($hauptinstrument->Einschaetzung)
                           value="{{$hauptinstrument->Einschaetzung->unterricht_seit}}"
                            @endif
                    >
